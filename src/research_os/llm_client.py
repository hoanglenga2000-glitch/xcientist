"""Unified dual-backend LLM client for the evolution engine.

Primary: Anthropic-native ``/v1/messages`` (works with the LT4Net gateway and the
official API). Fallback: DeepSeek OpenAI-style ``/v1/chat/completions``.
