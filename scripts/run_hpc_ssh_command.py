...
def connect_transport_password(
    ...
    if transport is None:
        raise paramiko.ssh_exception.AuthenticationException(
            "SSH transport was not established."
        )
...
def main() -> int:
    ...
    add_hpc_runtime_arguments(parser, include_remote_root=False)
    parser.add_argument("--command", default="")
    parser.add_argument("--command-file", default="")
    args = parser.parse_args()
    validate_hpc_runtime_arguments(parser, args, require_remote_root=False)
