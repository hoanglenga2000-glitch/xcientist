...
All output → ~/jinghw/scripts/gpu_tra/results/
"""
...
from sklearn.metrics import (
    accuracy_score, mean_squared_error, roc_auc_score, mean_absolute_error
)
...
def train_single(comp_name, cfg, n_folds=5, seed=42):
    ...
    if sample_sub_path:
        ...
        if task_type == "classification" and is_multiclass:
            ...
            if sample_dtype == bool or sample_dtype == np.dtype('bool'):
