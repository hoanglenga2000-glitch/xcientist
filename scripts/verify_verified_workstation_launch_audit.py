...
def main() -> None:
    ...
    require(dpapi.get("claude") is False, "Claude should remain not configured until an Anthropic key is installed", {"dpapi_loaded": dpapi})
    require(isinstance(dpapi.get("kaggle"), bool), "Kaggle DPAPI audit flag must be boolean", {"dpapi_loaded": dpapi})
