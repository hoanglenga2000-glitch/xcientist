...
def main() -> None:
    report = {
        ...
        "pdf_windows_command": 'ssh -o ProxyCommand="ncat --proxy 127.0.0.1:7890 --proxy-type socks5 %h %p" ${HPCSSH_ACCOUNT}@100.85.169.63 -p 1235',
        "fallback_command": 'ssh -o ProxyCommand="python scripts/hpc_socks_proxy.py 127.0.0.1 7890 %h %p" ${HPCSSH_ACCOUNT}@100.85.169.63 -p 1235',
    }
