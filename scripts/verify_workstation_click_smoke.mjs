...
const cdpPortEnvironment = "WORKSTATION_CDP_PORT";
...
async function run() {
  ...
  try {
    ...
    report = {
      ...
      runtime_errors: [],
      cleanup_warning: null,
      claim_boundary: "The real browser smoke did not complete because its isolated Chrome DevTools endpoint was unavailable."
    };
  } finally {
    client?.close();
