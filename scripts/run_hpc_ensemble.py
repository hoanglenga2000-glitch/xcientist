...
def main():
    ...
    p.add_argument("--user", required=True); p.add_argument("--host", required=True)
    p.add_argument("--port", type=int, default=1235); p.add_argument("--proxy-host", default="127.0.0.1")
    p.add_argument("--proxy-port", type=int, default=7890); p.add_argument("--password-env", required=True)
